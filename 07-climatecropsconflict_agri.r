...
load("data/conflict_agri.RData")


# conflict ----
acled_dt <- subset_dt[,.(x=longitude,y=latitude,country,date=event_date,year,type=disorder_type,event=event_type,civilian_targeting,fatalities,actor1,actor2)]
...
save(climatecropsconflict_dt,file="data/climatecropsconflict_agri.RData")
